...
#image = Image.open(img_name).convert('RGB')
    ...
    if label == 0:
        ...
        st.write("This photocard looks like SEVENTEEN Caratland 2021 trading card.")
    elif label == 3:
        st.write("This photocard looks like SEVENTEEN Haru Tour trading card.")
    elif label == 4:
        st.write("This photocard looks like SEVENTEEN Incomplete 2021 trading card.")
    elif label == 5:
        st.write("Oops! This is not a SEVENTEEN trading card.")
